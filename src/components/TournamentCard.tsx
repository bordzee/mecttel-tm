...
import { TournamentCoverImage } from './TournamentCoverImage'
...
export function TournamentCard({
  ...
  return (
    <Link
      ...
      className="block bg-card rounded-2xl border border-border overflow-hidden hover:border-brand-500/50 transition-colors"
    >
